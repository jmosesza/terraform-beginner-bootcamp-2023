# Terraform Beginner Bootcamp 2023 - Week 0
  ...
  * [Creating AWS Buckets](#creating-aws-buckets)
  * [Issues with Terraform Cloud Login and Gitpod Workspace](#issues-with-terraform-cloud-login-and-gitpod-workspace)
  * [Upgrade AWS CLI](#upgrade-aws-cli)
...
While fixing the Terraform CLI gpg depreciation issues we noticed that bash scripts steps were more code. So we decided to create a bash script to install the Terraform CLI.
...
`Do not add real credentials, access keys, or secret access keys into any documentation.`

We will need to generate AWS CLI credits from the IAM User in order to the user AWS CLI.
...
This command will skip the approve prompt.

#### Terraform Destroy

`terraform destroy`

This command will destroy resources.
...
Received the following prompt in the terminal when starting up the workspace 
`replace aws/README.md? [y]es, [n]o, [A]ll, [N]one, [r]ename:`

Updated the install_aws_cli
...
[How to upgrade AWS CLI to the latest version?](https://stackoverflow.com/questions/36969391/how-to-upgrade-aws-cli-to-the-latest-version)
