...
This project is going utilise semantic versioning for its tagging.
...
While fixing the Terraform CLI gpg depreciation issues we notice that bash scripts steps were more code. So we decided to create a bash script to install the Terraform CLI.
